...
| `+` | `+` |
| [debian-iso-builder-remix-bspwm](https://samwhelp.github.io/debian-iso-builder-remix-bspwm/) | [GitHub](https://github.com/samwhelp/debian-iso-builder-remix-bspwm) |
| `=` | `=` |
| [debian-iso-builder-respin-bspwm](https://samwhelp.github.io/debian-iso-builder-respin-bspwm/) | [GitHub](https://github.com/samwhelp/debian-iso-builder-respin-bspwm) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-remix-bspwm/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-remix-bspwm/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-remix-bspwm/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-remix-bspwm](https://github.com/samwhelp/debian-iso-builder-remix-bspwm)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-remix-bspwm.git
```


> change dir to `debian-iso-builder-remix-bspwm`

``` sh
cd debian-iso-builder-remix-bspwm
```
...
> change dir to `~/work/debian-iso-builder-remix-bspwm/iso-profile`

``` sh
cd ~/work/debian-iso-builder-remix-bspwm/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/debian-iso-builder-remix-bspwm/iso-profile/dist`
...
| Link | GitHub |
| ---- | ------ |
| [Bspwm / Adjustment](https://samwhelp.github.io/bspwm-adjustment/) | [GitHub](https://github.com/samwhelp/bspwm-adjustment) |
| [Bspwm / Note](https://samwhelp.github.io/note-about-bspwm/) | [GitHub](https://github.com/samwhelp/note-about-bspwm) |
